...
#        "${library_target_name} mismatch. Deduction stem: ${dictionary}.")
  ...
  message(STATUS "Currently accessing ${ARG_MODULE}")
  ...
  if(ARG_DEPENDENCIES)
    foreach(dep ${ARG_DEPENDENCIES})
      ...
      if (runtime_cxxmodules)
        if(TARGET "G__${dep}")
          get_target_property(arg_no_module "G__${dep}" ARG_NO_MODULE)
  ...
  if(TARGET "${ARG_MODULE}" AND NOT "${ARG_MODULE}" STREQUAL "${dictionary}")
    ...
    message(STATUS "${dictionary} property set ${ARG_NO_CXXMODULE}")
